...
export default function Submit() {
  const [form, setForm] = useState({
    title: '', abstract: '', type: 'research-paper',
...
await supabase.functions.invoke(
  ...
  if (status === 'success') {
    return (
      <div className="archive-container py-20 text-center">
        <p className="font-serif text-heading text-ink mb-2">Submission Received</p>
        <p className="text-caption text-ink-muted">
          Thank you. Your manuscript has been received and will be reviewed by our editors.
              ...
              <div className="flex flex-wrap gap-2">
                {CATEGORIES.map(cat => (
                  <button
                    ...
                    className={`cat-tag ${selectedCategories.includes(cat)
  ...
  <legend className="meta-label px-2">
    Authors
  </legend>
